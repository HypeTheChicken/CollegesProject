...
*/
myTopThreeColleges.StonyBrook={

      name:"StonyBrook",
      avgGPA: 3.76,
      avgSAT: 1837,
      potentialMajors:[ "History", "Journalism", "Classics"],
};

myTopThreeColleges.Oneonta={
...
myTopThreeColleges.NYU={
  ...
  myTopThreeColleges.NYU.averageIncomes={
...
myTopThreeColleges.Oneonta.averageIncomes={
...
myTopThreeColleges.StonyBrook.averageIncomes={
 
  "History":"$30,000",
  Journalism:"$28,000",
  Classics:"$24,500"
};
console.log(myTopThreeColleges);
...
*/
console.log("My first choice is " + myTopThreeColleges.StonyBrook.name);

for(key in myTopThreeColleges){
  console.log(myTopThreeColleges[key].averageIncomes);
};
